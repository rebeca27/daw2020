  ...
  <div class="register-page">
    <div class="register-panel">
      ...
      <form v-on:submit.prevent="registerUser()" class="register-panel__form">
        ...
        <div class="register-panel__form__row">
          <input type="text" v-model="firstName" class="register-panel__form__field" placeholder="First Name" id="register-first-name">
        </div>

        <div class="register-panel__form__row">
          <input type="text" v-model="lastName" class="register-panel__form__field" placeholder="Last Name" id="register-last-name">
        </div>
